...
public class ReservationTimeAdminController {
    ...
    @GetMapping
    @Operation(summary = "예약 시간 조회", description = "관리자 페이지에서 모든 예약 시간을 조회합니다.")
    @ApiResponses({
    ...
    @PostMapping
    @Operation(summary = "예약 시간 생성", description = "공통 예약 시간을 생성합니다.")
    @ApiResponses({
    ...
    public ResponseEntity<ReservationTimeResponse> create(
        ...
        URI location = URI.create("/admin/times/" + reservationTimeResult.id());
